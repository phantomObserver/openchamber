...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.branch.loadBranchTooltip': '加载此分支到工作区',
  ...
  'gitView.toast.commitCreatedOnBranch': '已在分支 {branch} 上创建提交',
  ...
  'chat.scrollToBottom.aria': '跳转到下一条用户消息',
  'chat.scrollToBottom.hold': '长按以跳转到会话结束处',
  'chat.jumpToPreviousMessage.aria': '跳转到上一条用户消息',
  'chat.jumpToPreviousMessage.hold': '长按以跳转到会话开始处',
  'chat.loadAllHistory.aria': '正在加载所有历史记录',
