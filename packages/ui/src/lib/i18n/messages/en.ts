...
export const dict = {
  ...
  'gitView.branch.loadBranchTooltip': 'Load this branch into workspace',
  ...
  'gitView.toast.commitCreatedOnBranch': 'Commit created on branch {branch}',
  ...
  'chat.scrollToBottom.aria': 'Jump to next user message',
