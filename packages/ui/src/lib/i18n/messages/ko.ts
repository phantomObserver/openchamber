...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.branch.loadBranchTooltip': '이 브랜치를 작업 공간에 로드',
  ...
  'gitView.branch.notLoaded': '로드되지 않음',
  ...
  'gitView.toast.commitCreatedOnBranch': '{branch} 브랜치에 커밋이 생성되었습니다',
  ...
  'chat.scrollToBottom.aria': '다음 사용자 메시지로 이동',
  'chat.scrollToBottom.hold': '길게 누르면 세션 끝 부분으로 이동',
  'chat.jumpToPreviousMessage.aria': '이전 사용자 메시지로 이동',
  'chat.jumpToPreviousMessage.hold': '길게 누르면 세션 시작 부분으로 이동',
  'chat.loadAllHistory.aria': '전체 기록 로드 중',
